class IntJoukko:
    def __init__(self, kapasiteetti: int=5, kasvatuskoko: int=5):
        if kapasiteetti < 0:
            raise ValueError("Kapasiteetin on oltava vähintään 0")
        self.kapasiteetti = kapasiteetti
        if kasvatuskoko < 0:
            raise ValueError("Kasvatuskoon on oltava vähintään 0")
        self.kasvatuskoko = kasvatuskoko
        self.lukujono = [0 for i in range(self.kapasiteetti)]
